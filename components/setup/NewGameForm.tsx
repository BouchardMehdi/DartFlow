      ...
      <form onSubmit={submit} className="grid gap-5 lg:grid-cols-[1fr_1.1fr]">
        <div className="space-y-5">
          <section className="rounded-[1.6rem] border border-[var(--line)] bg-[var(--panel)] p-5">
            ...
            <label className="mt-4 block"><span className="mb-2 block text-sm font-bold">Mode</span><SelectField value={mode} ariaLabel="Mode de jeu" options={[{ value: "count-up", label: "Count‑Up" }, { value: "301", label: "301" }, { value: "501", label: "501" }, { value: "701", label: "701" }, { value: "around-the-clock", label: "Around the Clock" }, { value: "shanghai", label: "Shanghai" }, { value: "cricket", label: "Cricket standard" }, { value: "killer", label: "Killer" }]} onChange={(value) => { const nextMode = value as typeof mode; setMode(nextMode); if ((nextMode === "count-up" || nextMode === "shanghai") && rounds === null) setRounds(nextMode === "shanghai" ? 7 : 8); if (nextMode === "killer" && players.length < 2) setPlayerCount(2); }} /></label>
