...
export function ResumeGameCard() {
  ...
  if (!game) return null;
  const mode = game.modeState.kind === "count-up" ? "Count‑Up" : game.modeState.kind === "x01" ? String(game.modeState.startingScore) : game.modeState.kind === "around-the-clock" ? "Around the Clock" : "Shanghai";
