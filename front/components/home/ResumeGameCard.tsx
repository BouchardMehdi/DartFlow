...
export function ResumeGameCard() {
  ...
  if (!game) return null;
  const mode = game.modeState.kind === "count-up" ? "Count‑Up" : game.modeState.kind === "x01" ? String(game.modeState.startingScore) : game.modeState.kind === "around-the-clock" ? "Around the Clock" : game.modeState.kind === "shanghai" ? "Shanghai" : game.modeState.kind === "cricket" ? "Cricket" : game.modeState.kind === "killer" ? "Killer" : game.modeState.trainingType === "doubles" ? "Entraînement doubles" : game.modeState.trainingType === "triples" ? "Entraînement triples" : game.modeState.trainingType === "checkout" ? "Checkout Challenge" : game.modeState.trainingType === "bobs-27" ? "Bob’s 27" : "Cible aléatoire";
